...
def differential_equation_for_process_response(u,t):
    x_model, x_dot, x, h, a1, a2, b1, b2 = u
    ...
    h_error = h-h_dot_estimate 
    a1_error = a1-a1_dot_estimate 
    a2_error = a2-a2_dot_estimate 
    b1_error = b1-b1_dot_estimate 
    b2_error = b2-b2_dot_estimate 
